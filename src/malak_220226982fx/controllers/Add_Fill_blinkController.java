 ...
 * @author NEW
 */
public class Add_Fill_blinkController implements Initializable {
    ...
    String answer = Question_answer_TF.getText();
    double marks = Double.parseDouble(Question_Mark_TF.getText());

    exam_system.createFillBlankQuestion(id, questionText, answer, marks);
